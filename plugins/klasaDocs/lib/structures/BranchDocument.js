const CustomDocument = require('./custom/CustomDocument');
const ClassDocument = require('./classes/ClassDocument');
const ExtendedMap = require('../util/ExtendedMap');

class BranchDocument extends ExtendedMap {
